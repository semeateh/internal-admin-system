window.FlowSeedData = {
  ...
  people: ["Zak", "Sandra", "陈辉", "刘依宁", "Gary", "Yolanda", "Jervis"],
  groups: {
  ...
  steps: [
    { name: "预确认信息", owner: "Zak", status: "current", desc: "确认销售区域、配套产品、相关产品销售区域是否一致。" },
    { name: "PN 分配", owner: "Sandra", status: "todo", desc: "填写并确认 PN 分配规则。" },
    { name: "品名确定", owner: "Sandra", status: "todo", desc: "确认中文品名、英文品名和相关销售资料。" },
    { name: "数据提供", owner: "Sandra", status: "todo", desc: "提交图片、参数、认证和卖点数据。" },
    { name: "规格书编写", owner: "Datasheet Team", status: "todo", desc: "多人共同完成规格书编写和复核。" },
    { name: "价格确定", owner: "Yolanda", status: "todo", desc: "完成价格表、价格区域和审批记录。" },
    { name: "市场宣发", owner: "市场宣发组", status: "todo", desc: "完成素材归档、推文、海报和内部通知。" },
    { name: "网站更新", owner: "刘依宁", status: "todo", desc: "更新网站产品页、资料下载和图片。" },
    { name: "发布完成确认", owner: "Zak", status: "todo", desc: "确认查检表、归档路径和最终通知。" }
  ]
};
